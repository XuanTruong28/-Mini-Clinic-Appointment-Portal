...
function check_session_timeout(): void {
    ...
    if (time() - $last > $idleLimit) {
        // 1. Lưu nội dung thông báo vào biến tạm
        $message = 'Phiên đăng nhập đã hết hạn. Vui lòng đăng nhập lại.';
        
        // 2. Logout sạch (xóa session, cookie, destroy)
        logout_clean();
        
        // 3. Khởi động lại session để có 'ngăn chứa' mới cho flash message
        session_start();
        
        // 4. Set flash message vào ngăn chứa mới đó
